<x-admin-layout title="Users" subtitle="Manage all platform users">
      ...
      <tr class="hover:bg-gray-50/50 transition">
        ...
        <td class="px-6 py-4">
          <span class="text-xs font-semibold px-2.5 py-1 rounded-full
            {{ $user->role === 'vendor' ? 'bg-orange-50 text-orange-600' : ($user->role === 'admin' ? 'bg-navy-50 text-navy-600' : 'bg-blue-50 text-blue-600') }}">
            {{ ucfirst($user->role) }}
          </span>
        </td>
        <td class="px-6 py-4">
