...
<?php $component->withAttributes(['title' => 'Sbrai Solutions — Verified Nigerian Marketplace','page' => 'home']); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6 text-center lg:text-left">
                    ...
                    <form action="/browse" method="get" class="max-w-2xl mx-auto lg:mx-0 bg-white p-2 rounded-2xl shadow-lg border border-gray-100 flex items-center gap-2">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-10 pb-16">
        <div class="flex flex-col sm:flex-row gap-6 items-start">
            <?php if (isset($component)) { $__componentOriginal7f92c092d0ac1818551003848ac9355e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7f92c092d0ac1818551003848ac9355e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-sidebar','data' => ['categories' => $categories]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal7f92c092d0ac1818551003848ac9355e)): ?>
<?php $attributes = $__attributesOriginal7f92c092d0ac1818551003848ac9355e; ?>
<?php unset($__attributesOriginal7f92c092d0ac1818551003848ac9355e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal7f92c092d0ac1818551003848ac9355e)): ?>
<?php $component = $__componentOriginal7f92c092d0ac1818551003848ac9355e; ?>
<?php unset($__componentOriginal7f92c092d0ac1818551003848ac9355e); ?>
<?php endif; ?>
