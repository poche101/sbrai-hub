...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.category-sidebar','data' => ['categories' => $categories ?? null,'active' => $activeCategory ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div class="mt-10 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p class="text-xs text-gray-400">&copy; <?php echo e(date('Y')); ?> Sbrai Solutions. All rights reserved.</p>
