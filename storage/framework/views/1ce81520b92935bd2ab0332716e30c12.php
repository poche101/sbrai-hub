...
<body>
  <div class="card">
    ...
    <p>Enter a new password for <?php echo e($email); ?>.</p>
...
<?php endif; ?>
    <?php if($errors->any()): ?>
      <div class="msg error"><?php echo e($errors->first()); ?></div>
    <?php endif; ?>

    <form method="POST" action="<?php echo e(url('/api/v1/auth/reset-password-form')); ?>">
      <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\kings\Downloads\sbrai-app-backend-FIXED\resources\views/auth/reset-password-form.blade.php ENDPATH**/ ?>