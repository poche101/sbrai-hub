...
<head>
    ...
    <title><?php echo e($title ?? 'Admin Dashboard'); ?> — Sbrai Solutions</title>
        ...
        <aside id="sidebar"
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto scrollbar-thin">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition <?php echo e(request()->routeIs('admin.dashboard*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.kyc.index')); ?>"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition <?php echo e(request()->routeIs('admin.kyc*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span class="truncate">KYC Requests</span>
                    <?php if(($stats['pending_kyc'] ?? 0) > 0): ?>
                        <span
                            class="ml-auto bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full flex-shrink-0"><?php echo e($stats['pending_kyc']); ?></span>
                    <?php endif; ?>
                </a>
                <a href="<?php echo e(route('admin.users.index')); ?>"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition <?php echo e(request()->routeIs('admin.users*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition <?php echo e(request()->routeIs('admin.categories*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.reports.revenue')); ?>"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition <?php echo e(request()->routeIs('admin.reports.revenue*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(route('admin.listings.index')); ?>"
                    class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-100 transition <?php echo e(request()->routeIs('admin.listings*') ? 'active' : ''); ?>">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                    ...
                    <div class="flex items-center gap-2 sm:pl-4 sm:border-l border-gray-200">
                        <div
                            ...
                            A</div>
                        <span
                            class="text-sm font-medium text-gray-700 hidden sm:inline truncate max-w-[140px]"><?php echo e(auth()->user()->full_name ?? 'Admin'); ?></span>
                    </div>
                </div>
            </header>
...
<?php /**PATH C:\Users\kings\Downloads\sbrai-app-backend-FIXED\resources\views/components/admin-layout.blade.php ENDPATH**/ ?>