        ...
        <form id="browse-filters" class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 mb-6">
            ...
            <div class="flex flex-wrap gap-2 mt-4 pt-4 border-t border-gray-100">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button
                        type="button" data-category-chip="<?php echo e($category->slug); ?>"
                        class="sbrai-chip <?php echo e($initial['category'] === $category->slug ? 'sbrai-chip-active' : ''); ?> px-4 py-2 rounded-full text-sm font-medium border border-gray-200"
